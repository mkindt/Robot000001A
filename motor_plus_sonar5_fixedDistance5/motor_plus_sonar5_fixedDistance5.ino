...
void loop()
{
  ...
  else if (cmF < 132 && northCount == 0 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
  else if (cmF < 122 && northCount == 1 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
  else if (cmF < 114 && northCount == 2 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
  else if (cmF < 107 && northCount == 3 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
  else if (cmF < 99 && northCount == 4 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
  else if (cmF < 91 && northCount == 5 && RCTime(11) < 8000){
    freeze();
    delay(600);
    northCount++;
  }
